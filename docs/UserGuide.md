...
| `Max marks should be an integer between 1 and 2147483647.`                                                                                                              | Ensure that max marks is a positive integer from 1 to 2147483647 (this is due to technical limits).                            |
